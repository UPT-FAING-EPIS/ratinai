        ...
        <div id="panel-historial" style="display:none;">
          ...
          <div class="card">
            ...
            <div class="history-item">
              ...
              <div style="flex:1"><p style="font-size:13px;font-weight:600;color:var(--text)">Paciente #PAC-00142</p><p class="text-sm text-muted">Retinopatía Diabética · 72% · 10 may 2026</p></div>
              <span class="badge badge-pending">Alerta</span>
            </div>
            <div class="history-item">
              <div class="history-dot" style="background:var(--success)"></div>
              <div style="flex:1"><p style="font-size:13px;font-weight:600;color:var(--text)">Paciente #PAC-00089</p><p class="text-sm text-muted">Normal · 95% · 08 may 2026</p></div>
              <span class="badge badge-active">Normal</span>
            </div>
            <div class="history-item">
              <div class="history-dot" style="background:var(--warning)"></div>
              <div style="flex:1"><p style="font-size:13px;font-weight:600;color:var(--text)">Paciente #PAC-00231</p><p class="text-sm text-muted">Glaucoma · 63% · 05 may 2026</p></div>
              <span class="badge badge-pending">Alerta</span>
            </div>
          </div>
        </div>
